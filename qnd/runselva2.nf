...
fileList=[]
idList=["CT432","CT433","CT434","CT435","MB286","MB290","MSB549","MSB550","MSB551","MSB552","MSB553","MSB554","MSB700","MSB701","MSB703","MSB704"]
idList.each{id->
    coolin = "${params.coolpath}/${id}/${id}.mcool"
    // Every .mcool file should have a corresponding sorted bam file...
    bamin = "${params.bampath}/${id}.bam"
